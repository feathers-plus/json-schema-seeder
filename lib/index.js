...
module.exports = function (options1 = {}) {
   ...
   */
  jsf.option({                    // defaults
    optionalsProbability: 0.75,   // 75% chance of population non-required properties
    resolveJsonPath: true,        // jsonPath: '...'. See https://github.com/dchester/jsonpath
  });
  if (options1.jsf) {
    jsf.option(options1.jsf);  // explicit configuration
  }
